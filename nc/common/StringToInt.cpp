...
template <class T>
boost::optional<T> stringToInt(const QString &s, int base) {
    T result;
...
#define NC_CONVERSION_INSTANTIATION(METHOD, TYPE) template boost::optional<TYPE> stringToInt(const QString &, int);
